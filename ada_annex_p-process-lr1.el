;;; ada_annex_p-process-lr1.el --- Generated parser support file  -*- buffer-read-only:t lexical-binding:t -*-
...
(defconst ada_annex_p-process-lr1-token-table
  [WHITESPACE
   NEW_LINE
   PLACEHOLDER
   COMMENT
...
(defconst ada_annex_p-process-lr1-face-table
  [
...
(defconst ada_annex_p-process-lr1-repair-image
  '(
   (ABORT . "abort")
   (ABS . "abs")
   (ABSTRACT . "abstract")
...
(provide 'ada_annex_p-process-lr1)
