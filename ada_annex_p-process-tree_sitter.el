;;; ada_annex_p-process-tree_sitter.el --- Generated parser support file  -*- buffer-read-only:t lexical-binding:t -*-
...
(defconst ada_annex_p-process-tree_sitter-token-table
  [PLACEHOLDER
   COMMENT
   CONFLICT_MARK_A
   CONFLICT_MARK_B
...
(defconst ada_annex_p-process-tree_sitter-face-table
  [
...
(defconst ada_annex_p-process-tree_sitter-repair-image
  '(
   (ABORT . "abort")
   (ABS . "abs")
   (ABSTRACT . "abstract")
...
(provide 'ada_annex_p-process-tree_sitter)
